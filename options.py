...
parser.add_argument('--data_downloaded', type=bool, default=False, help='Is data already downloaded?')
parser.add_argument('--data_path', type=str, default=None, help='If data is allready downloaded, specify the location')
