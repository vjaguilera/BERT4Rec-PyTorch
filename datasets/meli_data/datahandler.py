...
def process_events(dst_path, df_user_item_tmstmp):
    ...
    print('Dataset\n\tEvents: {}\n\tSessions: {}\n\tItems: {}'.format(len(df_user_item_tmstmp), df_user_item_tmstmp.user_id.nunique(), df_user_item_tmstmp.item_id.nunique()))
    df_user_item_tmstmp.to_csv(str(dst_path),
                                sep=';',
                                index=None,
                                header=None,
                                mode='a')
